...
class _ExpandableTextWidgetState extends State<ExpandableTextWidget> {
  ...
  Widget build(BuildContext context) {
    return Container(
      child: secondHalf.isEmpty?SmallText(text: firstHalf,size: Dimensions.font15,color: AppColors.paraColor,height: 1.8,):
      Column(
        children: [
          SmallText(text: hiddenText?(firstHalf+"..."):(firstHalf+secondHalf),size: Dimensions.font15,color: AppColors.paraColor,height: 1.5,),
          InkWell(
            onTap: (){
              setState(() {
